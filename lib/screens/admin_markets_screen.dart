...
///
/// [exchangeDataSource] is optional (tests); production uses [sl] when null.
class AdminMarketsScreen extends StatefulWidget {
  final ExchangeRemoteDataSource? exchangeDataSource;

  const AdminMarketsScreen({super.key, this.exchangeDataSource});
...
class _AdminMarketsScreenState extends State<AdminMarketsScreen> {
  ...
  ExchangeRemoteDataSource get _exchange =>
      widget.exchangeDataSource ?? sl<ExchangeRemoteDataSource>();

...
_LoginViewportLayout _layoutLoginForViewport(double maxH, double maxW) {
  ...
  var idealLogo =
      math.max(fromWidth, math.max(fromHeight, fromShortest)).clamp(120.0, 400.0);

  var padding = maxH < 560 ? 10.0 : maxH < 680 ? 14.0 : 24.0;
  var gapScale = maxH < 520 ? 0.5 : maxH < 600 ? 0.62 : maxH < 720 ? 0.78 : 1.0;
  var dense = maxH < 700;
        ...
        children: [
          ...
          FilledButton(
            ...
            style: FilledButton.styleFrom(
              padding: EdgeInsets.symmetric(vertical: lv.mainButtonVerticalPadding),
              visualDensity:
                  lv.denseInputs ? VisualDensity.compact : VisualDensity.standard,
            ),
            child: _isLoading
                ? const SizedBox(
                    height: 20,

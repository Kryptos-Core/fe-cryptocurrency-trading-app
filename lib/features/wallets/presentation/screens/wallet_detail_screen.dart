    ...
    return Scaffold(
      appBar: AppBar(
        title: Consumer<WalletsProvider>(
          builder: (context, provider, child) {
            return Text(provider.selectedWallet?.currency.symbol ??
                AppLocalizations.of(context).walletDetails);
          },
        ),
      ),
      body: Consumer<WalletsProvider>(
        builder: (context, provider, child) {
          ...
          if (wallet == null) {
            return Center(
                child: Text(AppLocalizations.of(context).walletNotFound));
          }
      ...
      child: ListTile(
        ...
        trailing: Column(
          ...
          children: [
            ...
            Text(
              AppLocalizations.of(context).walletBalanceAfter(

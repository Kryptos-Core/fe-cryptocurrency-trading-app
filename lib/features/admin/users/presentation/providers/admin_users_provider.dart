...
class AdminUsersProvider extends ChangeNotifier {
  ...
  List<UserLedgerOnchainTransaction> _onchainTxs = [];
  bool _isLoadingOnchainTxs = false;
  String? _onchainTxsError;

  List<UserLedgerOnchainTransaction> get onchainTxs =>
  ...
  UserLedgerOnchainTransaction _parseOnchainTx(Map<String, dynamic> json) {
    return UserLedgerOnchainTransaction(
